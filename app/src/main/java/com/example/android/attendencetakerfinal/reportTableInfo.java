...
public class reportTableInfo extends AppCompatActivity {
    DbHelper newDbHelper;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_report_table_info);
    ...
    private void displayTableInfo() {
        ...
        ListView listView=(ListView)findViewById(R.id.TableListedreport);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent=new Intent(reportTableInfo.this,reportShow.class);
