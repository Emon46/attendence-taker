...
public class Attendence extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton addingSubject = (FloatingActionButton) findViewById(R.id.addNewSubject);
        addingSubject.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent = new Intent(Attendence.this,createSubject.class);
    ...
    private void displayTableInfo() {
        ...
        ListView listView=(ListView)findViewById(R.id.TableListed);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent=new Intent(Attendence.this,AttendenceOfStudent.class);
